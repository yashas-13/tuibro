...
class LMStudioProvider(BaseProvider):
    ...
    def __init__(self, api_key=None, model=None, base_url=None):
        super().__init__(api_key or "", model, base_url or "http://localhost:1234/v1")
    ...
    async def complete(self, messages, tools=None):
        ...
        try:
            ...
            return ProviderResponse(error="LM Studio not running. Start LM Studio and load a model.")
